(function ($) {
  ...
  jQuery(function ($) {
    ...
    function update() {
      ...
      el.style.background = `conic-gradient(var(--adventure-primary-color1) ${pct}%, var(--progress-bg) ${pct}%)`;
  ...
  // Home demo menu
  const demoMenuWrapper = $(".adventure-demo-menu-wrapper");
  ...
  $(".adventure-demo-button").on("click", function () {
  ...
  // Adventure banner background slider
  if ($(".adventure-banner-slider").length) {
    new Swiper(".adventure-banner-slider", {
      slidesPerView: 1,
      effect: "fade",
      loop: true,
      speed: 1400,
      ...
      navigation: {
        nextEl: ".adventure-banner-slider-next",
        prevEl: ".adventure-banner-slider-prev",
      },
      fadeEffect: {
        crossFade: true,
      },
  ...
  // Adventure Category Slider
  var swiper = new Swiper(".adventure-category-slider", {
    slidesPerView: 1,
    speed: 1500,
    spaceBetween: 18,
    autoplay: {
    ...
    navigation: {
      nextEl: ".adventure-category-slider-next",
      prevEl: ".adventure-category-slider-prev",
    },
    breakpoints: {
      576: {
        slidesPerView: 2,
  ...
  // Adventure Testimonial Slider
  var swiper = new Swiper(".adventure-testimonial-slider", {
    slidesPerView: 1,
    speed: 1500,
    spaceBetween: 18,
    autoplay: {
    ...
    navigation: {
      nextEl: ".adventure-testimonial-slider-next",
      prevEl: ".adventure-testimonial-slider-prev",
    },
    breakpoints: {
      576: {
        slidesPerView: 1,
  ...
  // Adventure Package Details Gallery Slider
  ...
  // Adventure Destination Tourist Places Slider
  if (document.querySelector(".destination-tourist-places-slider")) {
    new Swiper(".destination-tourist-places-slider", {
      slidesPerView: 1,
      speed: 1200,
      spaceBetween: 20,
      autoplay: {
      ...
      navigation: {
        nextEl: ".destination-tourist-places-slider-next",
        prevEl: ".destination-tourist-places-slider-prev",
      },
      breakpoints: {
        250: {
          slidesPerView: 1,
  ...
  var swiper = new Swiper(".adventure-gallery-slider", {
    slidesPerView: "auto",
    speed: 1200,
    spaceBetween: 30,
    grabCursor: true,
    ...
    if ($(window).width() > 1024) {
      ...
      $('a[href^="#"]')
        ...
        .on("click", function (e) {
          ...
          var $scrollMarginTop =
            parseFloat(window.getComputedStyle($target[0]).scrollMarginTop) ||
            0;
          ...
          $("html, body").animate(
            {
              scrollTop: $target.offset().top - $offset - $scrollMarginTop,
            },
            600,
            function () {
  ...
  $(".single-search-box, .single-field").each(function () {
    ...
    $dropdown.on("click", function (e) {
      ...
      if (!$box.hasClass("date-field")) {
        $(".single-calendar").removeClass("active");
        $(".date-field").removeClass("is-calendar-active");
      }
    ...
    $wrap.find(".option-list-destination li").on("click", function () {
      ...
      const countryDestinationHtml = `<div class="destination"><strong class="ui-title">${country}</div>`;
  ...
  $(function () {
    ...
    $(document).on(
      "click",
      ".adventure-enquiry-modal .date-field-area",
      function (e) {
        e.preventDefault();
        e.stopPropagation();
        ...
        $(".adventure-enquiry-modal .single-calendar").removeClass("active");
        $(".adventure-enquiry-modal .form-inner").removeClass(
          "is-calendar-active",
        );
    ...
    $(document).on(
      "click",
      ".adventure-enquiry-modal .calendar .date:not(.disabled)",
      function () {
    ...
    $(document).on(
      "click",
      ".adventure-enquiry-modal .single-calendar-check",
      function (e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    $(".adventure-enquiry-modal .date-field-area input").val(
      moment(today).format("D MMMM YYYY"),
    );
    const tourDateFieldSelector =
      ".filter-input .date-field, .adventure-banner-search .date-field";
    ...
    $(tourDateFieldSelector).each(function () {
      ...
      const isBannerDateField = $dateField.hasClass("banner-date-field");

      if ($dateInput.length) {
        $dateInput.val(isBannerDateField ? "" : defaultTourBookingDate);
      }

      if ($dateDisplay.length) {
        if (isBannerDateField) {
          $dateDisplay.html(`<strong class="ui-title">Select date</strong>`);
        } else {
          $dateDisplay.html(
    ...
    document.addEventListener(
      ...
      function (event) {
        const segment = event.target.closest(
          ".adventure-tour-package-page-filter .filter-segment",
        );
        ...
        const filter = segment.closest(".adventure-tour-package-page-filter");
    ...
    $(
      ".filter-input .date-field .custom-select-dropdown, .filter-input .date-field .custom-select-dropdown input, .adventure-banner-search .date-field .custom-select-dropdown, .adventure-banner-search .date-field .custom-select-dropdown input",
    ).on("click", function (e) {
      e.stopPropagation();
  ...
  const maxAdventureTickets = 5;

  function updateAdventureTicketSummary($guestField) {
    const tickets =
      parseInt(
        $guestField.find('input[name="ticket_adult_quantity"]').first().val(),
        10,
      ) || 1;

    $guestField.find(".guest-adult-qty").text(tickets);
  }

  $(document).on(
    "click",
    ".adventure-tour-package-page-filter .guest-quantity__plus, .adventure-tour-package-page-filter .guest-quantity__minus",
    function (e) {
      e.preventDefault();
      e.stopPropagation();
      ...
      if ($btn.hasClass("guest-quantity__minus")) {
        ...
        value = Math.min(maxAdventureTickets, value + 1);
      }

      $input.val(value);
      updateAdventureTicketSummary($guestField);
    },
  );

  // Menu Destination hide show
  $("header.adventure-header .mega-menu .menu-single-item").on(
    "click",
    function () {
  ...
  // Adventure AI Chatbox
  jQuery(function ($) {
    const chatbox = $("#travelAiChatboxPopup");
    const aiButtons = $("header .ai-btn, .adventure-topbar-area .ai-btn");
    const startButton = chatbox.find(".adventure-ai-chatbox-start-btn");
    const newChatButton = chatbox.find(".adventure-ai-chatbox-new-chat");
    const introState = chatbox.find(".adventure-ai-chatbox-state-intro");
    const chatState = chatbox.find(".adventure-ai-chatbox-state-chat");
    const chatField = chatbox.find(".adventure-ai-chatbox-field");
    const chatMoreButton = chatbox.find(".adventure-ai-chatbox-more-btn");
    const screenshotButton = chatbox.find(
      ".adventure-ai-chatbox-screenshot-btn",
    );
    const uploadButton = chatbox.find(".adventure-ai-chatbox-upload-btn");
    const screenshotInput = chatbox.find(
      ".adventure-ai-chatbox-screenshot-input",
    );
    const uploadInput = chatbox.find(".adventure-ai-chatbox-upload-input");
    const filePreview = chatbox.find(".adventure-ai-chatbox-file-preview");
    ...
    chatbox.on("click", function (e) {
      e.stopPropagation();
      if (!$(e.target).closest(".adventure-ai-chatbox-more-btn").length) {
    ...
    filePreview.on("click", ".remove-file", function (e) {
      e.preventDefault();
      const img = $(this)
        .closest(".adventure-ai-chatbox-file-card")
        .find("img");
      if (img.length) {
      ...
      $(this).closest(".adventure-ai-chatbox-file-card").remove();
  ...
  $(".filter-btn").on("click", function (e) {
    ...
    $(".adventure-package-filter-area").toggleClass("slide");
    $(this).toggleClass("active"); // Toggle active class on filter button
  });

  $(document).on("click", function (e) {
    if (
      !$(e.target).closest(".adventure-package-filter-area, .filter-btn").length
    ) {
      $(".adventure-package-filter-area").removeClass("slide");
  ...
  if (clearBtns.length) {
    clearBtns.forEach(function (clearBtn) {
      clearBtn.addEventListener("click", function () {
        const filterArea =
          clearBtn.closest(".adventure-package-filter-area") || document;
